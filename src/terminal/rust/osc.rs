...
pub extern "C" fn ghostty_rust_osc_command_type(has_command: bool, kind: c_int) -> c_int {
    osc_command_type_impl(has_command, kind)
}

pub(crate) fn osc_command_type_impl(has_command: bool, kind: c_int) -> c_int {
...
pub unsafe extern "C" fn ghostty_rust_osc_command_data_string(
    ...
    unsafe { osc_command_data_string_impl(data, has_value, value, out) }
}

pub(crate) unsafe fn osc_command_data_string_impl(
    data: c_int,
    has_value: bool,
    value: *const u8,
    out: *mut c_void,
