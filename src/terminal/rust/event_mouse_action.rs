...
pub unsafe extern "C" fn ghostty_rust_mouse_event_set_action(event: *mut c_void, action: c_int) {
    unsafe {
        mouse_event_set_action_impl(event, action);
    }
}

pub(crate) unsafe fn mouse_event_set_action_impl(event: *mut c_void, action: c_int) {
    unsafe {
        ptr::write(
...
pub unsafe extern "C" fn ghostty_rust_mouse_event_get_action(event: *mut c_void) -> c_int {
    unsafe { mouse_event_get_action_impl(event) }
}

pub(crate) unsafe fn mouse_event_get_action_impl(event: *mut c_void) -> c_int {
...
pub unsafe extern "C" fn ghostty_rust_mouse_event_set_mods(event: *mut c_void, mods: u16) {
    unsafe {
        mouse_event_set_mods_impl(event, mods);
    }
}

pub(crate) unsafe fn mouse_event_set_mods_impl(event: *mut c_void, mods: u16) {
    unsafe {
        ptr::write(
...
pub unsafe extern "C" fn ghostty_rust_mouse_event_get_mods(event: *mut c_void) -> u16 {
    unsafe { mouse_event_get_mods_impl(event) }
}

pub(crate) unsafe fn mouse_event_get_mods_impl(event: *mut c_void) -> u16 {
